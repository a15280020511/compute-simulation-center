...
class StrategicIntelligenceTests(unittest.TestCase):
    def test_all_new_modes_are_allowlisted(self):
        ...
        self.assertTrue(set(INSTITUTIONAL_PREVIEW_MODES) <= set(ALL_SUPPORTED_MODES))
        self.assertTrue(set(SUPPORTED_MODES).isdisjoint(set(THINK_TANK_MODES)))
        self.assertTrue(set(SUPPORTED_MODES).isdisjoint(set(INSTITUTIONAL_PREVIEW_MODES)))
        self.assertTrue(set(THINK_TANK_MODES).isdisjoint(set(INSTITUTIONAL_PREVIEW_MODES)))
        self.assertEqual(len(SUPPORTED_MODES), 22)
        self.assertEqual(len(THINK_TANK_MODES), 38)
        self.assertEqual(len(INSTITUTIONAL_PREVIEW_MODES), 41)
        self.assertEqual(len(ALL_SUPPORTED_MODES), 101)
